const lineInitiatedLabels = {
  ...
  titleSecondBox: "Continuar configurando",
  descriptionSecond:
    "Haz clic en está opción, si deseas continuar configurando tu línea de crédito avanzado uno a uno por las reglas de negocio.",
  goBackButton: "Regresar",
  continueButton: "Continuar",
};

export { lineInitiatedLabels };
