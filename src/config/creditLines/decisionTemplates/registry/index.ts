...
const decisionTemplates: Record<string, IRuleDecision> = {
  ...
  "percentage-requested-amount": placeholderTemplate("Percentage Requested Amount"),
  "grace-period": placeholderTemplate("Grace Period"),
  "payment-channel-extraInstallments": placeholderTemplate("Payment Channel Extra Installments"),
  "adjustment-interest-payment-type": placeholderTemplate("Adjustment Interest Payment Type"),
  ...
  "maximum-percentage-extraordinary": placeholderTemplate("Maximum Percentage Extraordinary"),
  "percentage-available-monthly-payment": placeholderTemplate("Percentage Available Monthly Payment"),
  "lines-not-subtracted-analysis": placeholderTemplate("Lines Not Subtracted Analysis"),
};
