const detailsTabsConfig = {
  ...
  basicNotifFormatIncluded: {
    id: "basicNotifFormatIncluded",
    isDisabled: false,
  ...
  basicNotifRecipientIncluded: {
    id: "basicNotifRecipientIncluded",
    isDisabled: false,
  ...
  minCredBureauRiskScoreIncluded: {
    id: "minCredBureauRiskScoreIncluded",
    isDisabled: false,
  ...
  notificationChannelIncluded: {
    id: "notificationChannelIncluded",
    isDisabled: false,
  ...
  riskScoreApiUrlRemoved: {
    ...
    isDisabled: false,
    label: "Eliminadas URL de la API de score de riesgo",
  },
};
